...
const YTB = {
  // --- config ---
  // FROZEN SHARE BUILD — points at the isolated `stable` worker (see share/README.md).
  // Don't repoint at dev; this copy exists so a friend's instance stays stable
  // while extension/ keeps changing. Keep in sync with manifest.json host_permissions.
  BACKEND_URL: "https://youtube-buddy-stable.aidanchien18-a8d.workers.dev",
